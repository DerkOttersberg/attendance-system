...
def external_login():
    ...
    try:
        ...
        external_url = 'https://punten.bitsenbytes.net/api/login/BitsGoes1!'
        
        # Make the request to external API
        response = requests.get(external_url, timeout=5, verify=True)
        ...
        return jsonify({
            'success': False,
            'message': f'Connection error: Could not reach external API'
        }), 500
