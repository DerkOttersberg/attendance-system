    ...
    renderTodayTable(data) {
        ...
        return `
            <table>
                <thead>
                    <tr>
                        <th class="sortable" data-table="today" data-sort="name">Name</th>
                        <th class="sortable" data-table="today" data-sort="department">Department</th>
                        <th class="sortable" data-table="today" data-sort="clock_in">Clock In</th>
                        <th class="sortable" data-table="today" data-sort="clock_out">Clock Out</th>
                        <th class="sortable" data-table="today" data-sort="duration">Duration</th>
                        <th class="sortable" data-table="today" data-sort="status">Status</th>
                    </tr>
                </thead>
                <tbody>
                    ${data.map(record => `
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th class="sortable" data-table="all" data-sort="date">Date</th>
                        <th class="sortable" data-table="all" data-sort="name">Name</th>
                        <th class="sortable" data-table="all" data-sort="department">Department</th>
                        <th class="sortable" data-table="all" data-sort="clock_in">Clock In</th>
                        <th class="sortable" data-table="all" data-sort="clock_out">Clock Out</th>
                        <th class="sortable" data-table="all" data-sort="duration">Duration</th>
                        <th>Signature</th>
                    </tr>
                </thead>
                <tbody>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th class="sortable" data-table="users" data-sort="id">ID</th>
                        <th class="sortable" data-table="users" data-sort="rfid_uid">RFID UID</th>
                        <th class="sortable" data-table="users" data-sort="name">Name</th>
                        <th class="sortable" data-table="users" data-sort="email">Email</th>
                        <th class="sortable" data-table="users" data-sort="department">Department</th>
                        <th class="sortable" data-table="users" data-sort="product">Product</th>
                    </tr>
                </thead>
                <tbody>
                    ${users.map(user => `
    ...
    renderPointsTable(users) {
        ...
        return `
            <table>
                <thead>
                    <tr>
                        <th class="sortable" data-table="points" data-sort="id">ID</th>
                        <th class="sortable" data-table="points" data-sort="name">Name</th>
                        <th class="sortable" data-table="points" data-sort="points">Points</th>
                    </tr>
                </thead>
                <tbody>
                    ${users.map(user => `
                        <tr>
                            ...
                            <td ondblclick="makePointsEditable(event, ${user.id})">
                                <code data-points="${user.id}">${user.points ?? 0}</code>
                            </td>
                        </tr>
                    `).join('')}
                </tbody>
...
function makePointsEditable(event, userId) {
    event.stopPropagation();
    const td = event.currentTarget || event.target.closest('td');
    if (!td) return;
    const codeEl = td.querySelector(`code[data-points="${userId}"]`);
    if (!codeEl) return;

    const original = codeEl.textContent || '0';
    ...
    input.addEventListener('keydown', async function(e) {
        if (e.key === 'Enter') {
            ...
            try {
                input.disabled = true;
                await API.setUserPoints(userId, newVal);
                if (window.loadPoints) await window.loadPoints();
            } catch (err) {
                console.error('Failed to update points:', err);
                alert('Failed to update points: ' + (err.message || err));
                td.removeChild(input);
                td.appendChild(codeEl);
                codeEl.textContent = original;
            }
