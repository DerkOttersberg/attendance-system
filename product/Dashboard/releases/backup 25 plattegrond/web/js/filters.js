...
const Filters = {
    async applyFilters() {
        ...
        try {
            ...
            if (window.renderAllAttendance) {
                window.renderAllAttendance();
            } else {
...
async function submitManualAttendance() {
    ...
    try {
        ...
        // Points are updated server-side when clock out time is provided
...
async function updatePointsPreview() {
    ...
    try {
        ...
        const currentPoints = await fetchUserPointsFromLocal(user.id);
...
// Fetch user's current points from local dashboard
async function fetchUserPointsFromLocal(userId) {
    try {
