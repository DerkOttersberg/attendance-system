...
public:
    ...
    void RenderAdminPasswordScreen(ImDrawList* draw_list, const std::string& password_buffer) {
        ...
        for (int digit = 1; digit <= 9; digit++) {
            ...
            float btn_radius = (KEYPAD_BUTTON_W < KEYPAD_BUTTON_H ? KEYPAD_BUTTON_W : KEYPAD_BUTTON_H) * 0.5f;
            
            draw_list->AddCircleFilled(btn_center, btn_radius, IM_COL32(220, 220, 220, 255), 32);
            draw_list->AddCircle(btn_center, btn_radius, IM_COL32(150, 150, 150, 255), 32, 2.0f);
