...
int main(int, char**)
{
    ...
    std::vector<std::vector<ImVec2>> strokes;  // All completed strokes
    std::vector<ImVec2> currentStroke;         // Current stroke being drawn
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::Text("Strokes: %zu", strokes.size());
        ImGui::Spacing();
        ...
        ImGui::Spacing();
        if (ImGui::Button("Clear Drawing", ImVec2(300, 60)))
        {
            strokes.clear();
            currentStroke.clear();
